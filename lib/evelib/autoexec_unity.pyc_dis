#Embedded file name: c:\depot\games\branches\release\EVE-TRANQUILITY\eve\common\lib\autoexec_unity.py
Done = False
import blue
import sys
import os
...
def StartClient(appCacheDirs, userCacheDirs, builtinSetupHook, servicesToRun, preUIStartArgProcessHook, StartupUIServiceName, startInline = []):
    ...
    unityCorePath = blue.paths.ResolvePath(u'root:/unity/script')
