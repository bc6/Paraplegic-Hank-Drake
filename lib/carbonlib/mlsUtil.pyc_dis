...
class Mls(object):
    ...
    def __init__(self):
        ...
        self.__englishWrapper = LabelWrap('EN')
    ...
    if original.find('%(') >= 0:
        ...
        for i in xrange(100):
            ...
            try:
                ...
                elif e.args[0].startswith("unsupported format character '"):
                    sys.exc_clear()
        ...
        try:
            ...
            elif e.args[0] in ('%d format: a number is required, not str', 'an integer is required', 'int argument required'):
                sys.exc_clear()
