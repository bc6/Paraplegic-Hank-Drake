...
class LogManager(object):
    ...
    screen = property(_get_screen, _set_screen, doc='If True, error and access will print to stderr.')
    ...
    wsgi = property(_get_wsgi, _set_wsgi, doc='If True, error messages will be sent to wsgi.errors.')
