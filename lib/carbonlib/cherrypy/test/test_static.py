...
class StaticTest(helper.CPWebCase):
    ...
    def test_config_errors(self):
        ...
        self.assertInBody('TypeError: staticdir() takes at least 2 arguments (0 given)')
    ...
    def test_file_stream(self):
        ...
        while remaining > 0:
            ...
            (s, h, b,) = helper.webtest.openURL('/tell', headers=[], host=self.HOST, port=self.PORT, http_conn=newconn)
            if not b:
