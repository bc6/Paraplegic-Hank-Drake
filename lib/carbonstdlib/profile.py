...
class Profile():
    ...
    def _calibrate_inner(self, m, verbose):
        ...
        if verbose:
            print 'elapsed time without profiling =',
            print elapsed_noprofile
        p = Profile()
        t0 = get_time()
        ...
        if verbose:
            print "'CPU seconds' profiler reported =",
            print reported_time
            print 'total # calls =',
            print total_calls
        if total_calls != m + 1:
        ...
        if verbose:
            print 'mean stopwatch overhead per profile event =',
            print mean
        return mean
