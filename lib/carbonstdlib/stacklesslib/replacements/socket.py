...
if __name__ == '__main__':
    ...
    def TestTCPServer(address):
        ...
        i = 1
        while i < NUM_TESTS + 1:
            print 'server connection wait',
            print i
            (currentSocket, clientAddress,) = listenSocket.accept()
            print 'server',
            print i,
            print 'listen socket',
            print currentSocket.fileno(),
            print 'from',
            print clientAddress
            if i == 1:
                print 'server closing (a)',
                print i,
                print 'fd',
                print currentSocket.fileno(),
                print 'id',
                print id(currentSocket)
                currentSocket.close()
                print 'server closed (a)',
                print i
            elif i == 2:
                print 'server test',
                print i,
    ...
    def TestTCPClient(address):
        ...
        print 'client connection (1) fd',
        print clientSocket.fileno(),
        print 'id',
        print id(clientSocket._sock),
    ...
    def TestMonkeyPatchUrllib(uri):
        ...
        try:
            ...
            if len(s) != 0:
                print 'Fetched',
                print len(s),
                print 'bytes via replaced urllib'
            else:
    ...
    if len(sys.argv) == 2:
        if sys.argv[1] == 'client':
            ...
            print 'Usage:',
            print sys.argv[0],
            print '[client|server|slpclient|slpserver]'
        sys.exit(1)
    else:
