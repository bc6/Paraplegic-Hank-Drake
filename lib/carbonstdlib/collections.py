...
class OrderedDict(dict, MutableMapping):
    ...
    def __init__(self, *args, **kwds):
        ...
        try:
            ...
            self._OrderedDict__root = root = [None, None, None]
            PREV = 0
            NEXT = 1
    ...
    def __reduce__(self):
        ...
        tmp = (self._OrderedDict__map, self._OrderedDict__root)
        del self._OrderedDict__map
        del self._OrderedDict__root
        inst_dict = vars(self).copy()
        (self._OrderedDict__map, self._OrderedDict__root,) = tmp
        if inst_dict:
    ...
    def clear(self):
        try:
            ...
            self._OrderedDict__root[:] = [self._OrderedDict__root, self._OrderedDict__root, None]
