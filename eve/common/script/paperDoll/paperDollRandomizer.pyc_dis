#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/common/script/paperDoll/paperDollRandomizer.py
    ...
    def GetGender(self):
        if not self.__gender:
            if random.randint(0, 1) == 0:
                self.__gender = PD.GENDER.FEMALE
            else:
                self.__gender = PD.GENDER.MALE
