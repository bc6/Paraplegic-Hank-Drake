#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/camera/debugChangeCameraSettingsWindow.py
import util
import uicls
import uiutil
import uiconst
...
class DebugChangeCameraSettingsWindow(uicls.Window):
    ...
    def ApplyAttributes(self, attributes):
        ...
        self.heading = uicls.Label(text='Change Camera Settings', parent=self.sr.main, align=uiconst.TOPLEFT, left=65, top=-40, width=self.width - 10, height=self.height - 10, fontsize=25, maxLines=1, uppercase=1)
    ...
    def AddEntry(self, rowPos, colPos, variableName, humanName, associatedObject):
        if not hasattr(associatedObject, variableName):
            ...
            edit = uicls.SinglelineEdit(name=variableName, readonly=False, parent=self.sr.main, maxLines=1, align=uiconst.RELATIVE, pos=(colPos + 145,
             rowPos - 5,
             100,
             25), padding=(0, 0, 0, 0))
