#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/control/listgroup.py
import util
import uix
import uiutil
import form
...
class ListGroup(uicls.SE_ListGroupCore):
    ...
    def Startup(self, *etc):
        ...
        self.sr.labelClipper = uicls.Container(parent=self, name='labelClipper', align=uiconst.TOALL, pos=(0,
         0,
         const.defaultPadding,
         0), clipChildren=1)
        self.sr.labelClipper.OnClick = self.OnClick
        self.sr.labelClipper.GetMenu = self.GetMenu
        self.sr.label = uicls.EveLabelMedium(text='', parent=self.sr.labelClipper, left=5, state=uiconst.UI_DISABLED, maxLines=1, idx=0, align=uiconst.CENTERLEFT)
