#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/control/hybridWindow.py
import uix
import uiutil
import xtriui
import form
...
class HybridWindow(uicls.Window):
    ...
    def Close(self, *args, **kwds):
        if self.HasPendingModalResult():
            return uicls.Window.Close(self, *args, **kwds)
