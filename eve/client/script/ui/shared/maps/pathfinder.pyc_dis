#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/shared/maps/pathfinder.py
import service
import blue
import destiny
import time
...
class PathfinderSvc(service.Service):
    ...
    def RefreshPodKills(self):
        ...
        if self.lastPKversionNumber == -1:
            podKills = sm.RemoteSvc('map').GetHistory(*args)
