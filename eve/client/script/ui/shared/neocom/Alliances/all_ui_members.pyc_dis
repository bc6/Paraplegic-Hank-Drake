#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/shared/neocom/Alliances/all_ui_members.py
import util
import xtriui
import uix
import listentry
...
class Corporation(listentry.Generic):
    ...
    def Startup(self, *args):
        self.sr.label = uicls.EveLabelMedium(text='', parent=self, left=5, state=uiconst.UI_DISABLED, maxLines=1)
