#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/shared/neocom/corporation/corp_ui_member_auditing.py
import blue
import uthread
import util
import xtriui
    ...
    def Load(self, args):
        ...
        if not self.sr.Get('inited', 0):
            ...
            if len(memberIDs) < 24:
                ...
                searchMember = uicls.SinglelineEdit(name='searchMember', parent=toppar, align=uiconst.TOPLEFT, left=toDate.left + toDate.width + 6, top=toDate.top, width=92, maxLength=37, label=localization.GetByLabel('UI/Corporations/CorporationWindow/Members/Auditing/SearcForMember'), isCharacterField=True)
