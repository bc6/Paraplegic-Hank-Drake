#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/shared/neocom/corporation/corp_ui_standings.py
import util
import xtriui
import uix
import uiutil
...
class CorporationOrAlliancePickerDailog(uicls.Window):
    ...
    def ApplyAttributes(self, attributes):
        ...
        self.sr.txtWarning = uicls.EveLabelMedium(parent=self.sr.main, align=uiconst.TOBOTTOM, top=0, color=[1,
         0,
         0,
