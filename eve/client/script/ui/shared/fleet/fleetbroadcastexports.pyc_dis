#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/shared/fleet/fleetbroadcastexports.py
import util
import dbg
import menu
import state
...
def GetWarpLocationMenu(locationID):
    ...
    menuSvc = sm.GetService('menu')
    defaultWarpDist = menuSvc.GetDefaultActionDistance('WarpTo')
    ret = [[uiutil.MenuLabel('UI/Inflight/WarpToBookmark'), menuSvc.WarpToItem, (locationID, float(defaultWarpDist))], [uiutil.MenuLabel('UI/Inflight/Submenus/WarpToWithin'), menuSvc.WarpToMenu(menuSvc.WarpToItem, locationID)], [uiutil.MenuLabel('UI/Inflight/AlignTo'), menuSvc.AlignTo, (locationID,)]]
