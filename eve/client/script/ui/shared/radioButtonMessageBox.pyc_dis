#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/shared/radioButtonMessageBox.py
import blue
import uix
import uiutil
import xtriui
...
class RadioButtonMessageBox(form.MessageBox):
    ...
    def Execute(self, text, title, buttons, radioOptions, icon, suppText, customicon = None, height = None, width = None, default = None, modal = True):
        ...
        caption = uicls.CaptionLabel(text=title, align=uiconst.CENTERLEFT, parent=self.sr.topParent, left=64, width=270)
