#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/ui/login/charcreation/charCreationColorPicker.py
import uiconst
import uicls
import mathUtil
import math
...
class CharCreationColorPicker(uicls.Container):
    ...
    def InitColors(self, colors, activeColorIndex = 0):
        ...
        self.sr.colorSample = uicls.Sprite(parent=self.sr.centerParent, texturePath='res:/UI/Texture/none.dds', ignoreSize=True, align=uiconst.TOALL, pos=(0, 0, 0, 0), state=uiconst.UI_DISABLED, color=(1.0, 1.0, 1.0, 0.0))
