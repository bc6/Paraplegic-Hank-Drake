...
class ClientPlanet(planet.BasePlanet):
    ...
    def RemovePin(self, pinID):
        ...
        if pin.IsCommandCenter():
            ...
            self.changes.Reset()
        elif colony.IsTemporaryID(pinID):
    ...
    def CreateResourceInfo(self, resourceTypeID, entry):
        ...
        elif util.IsWormholeSystem(session.solarsystemid2) or sm.GetService('pathfinder').GetJumpCountFromCurrent(planetInfo.solarSystemID) > 1000:
