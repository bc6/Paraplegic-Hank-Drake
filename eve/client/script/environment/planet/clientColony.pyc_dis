#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/eve/client/script/environment/planet/clientColony.py
import planet
import planetCommon
import blue
...
class ClientColony(planet.BaseColony):
    ...
    def PostValidateCreatePin(self, charID, typeID, latitude, longitude):
        ...
        if typeObj.groupID != const.groupCommandPins:
            ...
            if session.solarsystemid2 not in sm.GetService('facwar').GetFacWarSystems():
