#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/carbon/client/script/ui/uitest/helloWorld.py
import uiconst
import uicls
import uiutil
import trinity
...
class HelloWorld(uicls.Container):
    ...
    def ApplyAttributes(self, attributes):
        ...
        uicls.Label(parent=self, pos=(20, 200, 300, 60), maxLines=1, text='Hello_world!')
...
class HelloWorldWizardPage1(uicls.Container):
    ...
    def ApplyAttributes(self, attributes):
        uicls.Container.ApplyAttributes(self, attributes)
        uicls.Label(parent=self, pos=(20, 200, 300, 20), maxLines=1, text='First')
...
class HelloWorldWizardPage2(uicls.Container):
    ...
    def ApplyAttributes(self, attributes):
        uicls.Container.ApplyAttributes(self, attributes)
        uicls.Label(parent=self, pos=(20, 200, 300, 20), maxLines=1, text='Second')
