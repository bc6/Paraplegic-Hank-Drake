#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/carbon/client/script/ui/control/browser/browserutil.py
import trinity
import blue
import urllib2
import urllib
...
def GetErrorString(errorCode):
    ...
    if errorCode == LoadErrors.FILE_NOT_FOUND:
        ...
        if errorCode == LoadErrors.CERT_COMMON_NAME_INVALID:
            ...
            errorString += localization.GetByLabel('UI/Browser/LoadErrorCertificateError')
