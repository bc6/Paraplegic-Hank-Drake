#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/carbon/client/script/ui/control/buttons.py
import fontConst
import uicls
import uiconst
import uiutil
...
class ButtonCore(uicls.Container):
    ...
    def Prepare_(self):
        ...
        self.sr.activeframe = uicls.Frame(parent=self, name='activeframe', state=uiconst.UI_HIDDEN, color=(1.0, 1.0, 1.0, 0.3), frameConst=uiconst.FRAME_BORDER1_SHADOW_CORNER4)
