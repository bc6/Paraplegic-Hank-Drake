#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/carbon/client/script/ui/util/uiAnimationTest.py
import uicls
import uiconst
import trinity
MODE_NORMAL = 1
...
class TestAnimationsWnd(uicls.Window):
    ...
    def ConstructMainCont(self):
        ...
        if self.mode is MODE_NORMAL:
            ...
            self.codeEdit = uicls.SinglelineEdit(parent=self.spriteCont, align=uiconst.TOTOP, label='Code that returns a UI object:', heigt=15, padding=(10, 30, 150, 0), setvalue=settings.user.ui.Get('TestAnimationsWndCode', 'uicore.layer.sidePanels'))
