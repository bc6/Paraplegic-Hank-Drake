#Embedded file name: c:/depot/games/branches/release/EVE-TRANQUILITY/carbon/common/script/world/worldSpaceBenchmark.py
import blue
import geo2
import os
...
class WorldSpaceBenchmark(object):
    ...
    def GeneratePositionsGrid(self, vMin, vMax, xSteps, zSteps, yPos):
        ...
        if zSteps > 1:
            ...
            zStep = 0
        print 'Step Size', xStep, zStep, y, vMin[1], vMax[1]
        self.pointList = []
        x = vMin[0]
